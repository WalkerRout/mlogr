...
namespace ML {
  ...
  // Return values : N/A
  LogisticRegression::LogisticRegression(unsigned int epochs, double learning_rate){
    this->epochs = epochs;
  ...
  double LogisticRegression::dot(std::vector<double> x_i, std::vector<double> b_i){
    double prod = 0.0;
  ...
  double LogisticRegression::predict(std::vector<double> x_i, std::vector<double> b_i){
  ...
  double LogisticRegression::logloss(double y_i, double y_hat){
  ...
  double LogisticRegression::error(std::vector<double> y_i, std::vector<double> y_hat_i){
    size_t len = y_i.size();
    double loss = 0.0;
  ...
  std::vector<double> LogisticRegression::gradient_cost(std::vector< std::vector<double> > X, std::vector<double> b_i, std::vector<double> y_i){
    int size = b_i.size();
  ...
  std::vector<double> LogisticRegression::gradient_descent(const std::vector< std::vector<double> > X, std::vector<double> b_i, const std::vector<double> y_i){
